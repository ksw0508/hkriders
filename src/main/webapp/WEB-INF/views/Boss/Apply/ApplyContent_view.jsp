...
<div class="container">
	...
	<c:forEach items="${modify}" var="dto">
		...
		<div id="content">
			...
			<input type="hidden" id="lat" name="asLat" value="${dto.asLat}">
			<input type="hidden" id="lng" name="asLng" value="${dto.asLng}">
			...
			<div id="catagory">
				<select name="asCategory">
				    <option value="${dto.asCategory}">카테고리를 선택하세요.</option>
			...
			<input id="MAmodify" class="btn btn-danger text-white" type="submit" value="수정">
