...
<!-- 업체코드는 시퀀스로 얻기 -->
	...
	<c:forEach items="${Smodify}" var="dto">
		...
		<div id="content">
			...
			<!-- 사업자번호 추가하기 -->
			<input type="tel" name="bNo" pattern="[0-9]{3}-[0-9]{2}-[0-9]{5}" required value="${dto.bNo}">
			<br/><br/>
			
			<img class="img-thumbnail" src="/image/Store/${dto.sImg}"> 
			<br/><br/>
			
			<!-- 위도 경도는 페이지에서는 숨겨서 받고 db에는 전송 -->
			<input type="text" id="lat" name="sLat" value="${dto.sLat}" style="display:none">
			<input type="text" id="lng" name="sLng" value="${dto.sLng}" style="display:none">
			
			<input type="search" id="address" name="sAd" value="${dto.sAd}">
			<br/>
			...
			<b>가게전화번호</b><br/>
			<input type="tel" name="sPhone" value="${dto.sPhone}">
			<br/><br/>
			
			<div id="catagory">
				<select name="sCategory">
				    <option value="${dto.sCategory}">카테고리를 선택하세요.</option>
			...
			<input type="number" name="mPrice" value="${dto.mPrice}" min="0" max="30000" step="1000" value="0">
			<br/><br/>
			<b>회원아이디</b><br/>
			<input type="text" value="${dto.user_id}" readonly>
			<br/><br/>
			
			<input class="btn btn-danger text-white" id="submit" type="submit" value="수정">
