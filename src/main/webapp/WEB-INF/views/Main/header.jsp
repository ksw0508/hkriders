...
<nav class="navbar navbar-expand-sm navbar-dark">
	<div class="container">
		...
		<a id="logo" href="cart"><h3 class="fas fa-shopping-cart"></h3></a> 
		
		<!-- 사장이면 사장페이지 이동링크 --> 
		<sec:authorize access="hasRole('ROLE_BOSS')">
	 		<a href="BossHome" class="text-white" style="margin-top:15px; padding-left:35px;"><h3 class="fas fa-user-tie">B</h3></a>  
		</sec:authorize>
		
		<!-- 관리자면 관리자페이지 이동링크 --> 
		<sec:authorize access="hasRole('ROLE_ADMIN')">
	 		<a href="ManagerHome" class="text-white" style="margin-top:15px; padding-left:35px;"><h3 class="fas fa-user-lock">M</h3></a>  
		</sec:authorize>
 	</div>
</nav>
